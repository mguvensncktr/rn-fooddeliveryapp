import { View, Text, SafeAreaView, StyleSheet, TouchableOpacity, Image, FlatList, Platform } from 'react-native'
    ...
    function renderHeader() {
        return (
            ...
            >
                ...
                >
                    <Image source={icons.nearby} resizeMode="contain" style={{
                        width: 30,
                        height: 30
                    }} />
                </TouchableOpacity>
        ...
        const renderItem = ({ item }) => {
            return (
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("Details", { item, currentLocation })}
                >
                            ...
                            {item.categories.map((categoryId) => {
                                return (
                                    <View
                                        ...
                                        key={categoryId}
                                    >
                                        <Text style={{ ...FONTS.body3 }}>{getCategoryName(categoryId)}</Text>
